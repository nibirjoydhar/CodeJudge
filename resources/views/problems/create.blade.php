                            ...
                            <div id="test_cases_container" class="space-y-4">
                                <div class="test-case border rounded p-4 bg-gray-50">
                                    <div class="mb-2">
                                        ...
                                        <textarea name="test_cases[0][input]" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 font-mono bg-white" required></textarea>
                                    </div>
                                    <div class="mb-2">
                                        <label class="block text-sm font-medium text-gray-700">Expected Output</label>
                                        <textarea name="test_cases[0][expected_output]" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 font-mono bg-white" required></textarea>
                                    </div>
                                    <div class="flex items-center space-x-4">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" name="test_cases[0][is_sample]" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                            <span class="ml-2 text-sm text-gray-600">Sample Test Case</span>
                                        </label>
                                        <div>
                                            <label class="text-sm text-gray-600">Points</label>
                                            <input type="number" name="test_cases[0][points]" value="0" min="0" class="ml-2 w-20 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white">
                                        </div>
                                    </div>
                                </div>
                            </div>
