                ...
                <div class="p-6 text-gray-900">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($submissions as $submission)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full break-words
                    ...
                    @else
                        <div class="text-center py-10">
                            <p class="text-gray-500">{{ __('No submissions found.') }}</p>
                            <a href="{{ route('submissions.create') }}" class="mt-4 inline-flex items-center px-4 py-2 bg-indigo-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-600 active:bg-indigo-700 focus:outline-none focus:border-indigo-700 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150">
                                {{ __('Make Your First Submission') }}
                            </a>
                        </div>
                    @endif
                </div>
